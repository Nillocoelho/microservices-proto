...
const file_shipping_shipping_proto_rawDesc = "" +
	"\n\x19shipping/shipping.proto\"8\n\x0cShippingItem\x12\x14\n\x05product_code\x18\x01 \x01(\tR\x04" +
	"product_code\x12\x12\n\x08quantity\x18\x02 \x01(\x05R\x05quantity\"\x68\n\x16CreateShippingRequest\x12\x0f\n" +
	"\border_id\x18\x01 \x01(\x03R\aorder_id\x12=\n\x05items\x18\x02 \x03(\v2\r.ShippingItemR" +
	"\x05items\"G\n\x17CreateShippingResponse\x12\x12\n\nshipping_id\x18\x01 \x01(\x03R\tshipping_id\x12\x18\n" +
	"\x0fdelivery_days\x18\x02 \x01(\x05R\x0edelivery_days2e\n\x08Shipping\x12Y\n" +
	"\x06Create\x12\x17.CreateShippingRequest\x1a\x18.CreateShippingResponseR\x00b\x06proto3"
